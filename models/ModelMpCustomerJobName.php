 ...
 */
class ModelMpCustomerJobName extends ObjectModel
{
    public $name;
    public $date_add;
    public $date_upd;
    ...
    public function install()
    {
        ...
        $sql = "CREATE TABLE IF NOT EXISTS `{$table}` (
            `id_customer_job_name` INT(11) NOT NULL AUTO_INCREMENT,
            `name` VARCHAR(64) NOT NULL,
            `date_add` DATETIME NOT NULL,
            `date_upd` DATETIME NOT NULL,
            PRIMARY KEY (`id_customer_job_name`)
        ...
        $sql_lang = "CREATE TABLE IF NOT EXISTS `{$table}_lang` (
            ...
            `name` VARCHAR(64) NOT NULL,
            PRIMARY KEY (`id_customer_job_name`, `id_lang`)
        ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;";
